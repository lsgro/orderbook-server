...
struct ConsolidateLevel {
    price: Decimal,
    exchange_levels: HashMap<&'static str, Level>,
}
...
impl ConsolidateLevel {
    ...
    fn from_levels(levels: Vec<Level>) -> ConsolidateLevel {
...
mod tests {
    ...
    fn test_consolidate_level_create_from_level() {
        let level = Level::from_strs("test", "100.0", "99.9");
    ...
    fn test_consolidate_level_create_from_levels() {
        let level1 = Level::from_strs("test1", "100.0", "99.9");
        let level2 = Level::from_strs("test2", "100.0", "99.9");
    ...
    fn test_consolidate_level_create_from_levels_panics() {
        let level1 = Level::from_strs("test1", "100.0", "99.9");
        let level2 = Level::from_strs("test2", "99.0", "99.9");
    ...
    fn test_consolidate_level_update_correct() {
        let level1 = Level::from_strs("test1", "100.0", "99.9");
        let level2 = Level::from_strs("test2", "100.0", "90.0");
    ...
    fn test_consolidate_level_update_panics() {
        let level1 = Level::from_strs("test", "100.0", "99.9");
        let level2 = Level::from_strs("test", "99.0", "90.0");
        let mut cons_level = ConsolidateLevel::from_level(level1);
    ...
    fn test_add_at_beginning_to_asks_side() {
        ...
        let asks_update = vec![
            Level::from_strs("test2", "99", "10"),
            Level::from_strs("test2", "100", "10"),
            Level::from_strs("test2", "101", "10"),
        ];
        Consolidate::update_side(&mut asks, asks_update, true);
        let exp_asks = vec![
            ConsolidateLevel::from_level(Level::from_strs("test2", "99", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test2", "100", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test2", "101", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test1", "102", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test1", "104", "10")),
    ...
    fn test_add_at_end_to_asks_side() {
        ...
        let asks_update = vec![
            Level::from_strs("test2", "107", "10"),
            Level::from_strs("test2", "108", "10"),
            Level::from_strs("test2", "109", "10"),
        ];
        Consolidate::update_side(&mut asks, asks_update, true);
        let exp_asks = vec![
            ConsolidateLevel::from_level(Level::from_strs("test1", "102", "10")),
            ...
            ConsolidateLevel::from_level(Level::from_strs("test1", "106", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test2", "107", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test2", "108", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test2", "109", "10")),
        ];
        assert_eq!(asks, exp_asks);
    }
    ...
    fn test_update_and_add_into_bids_side() {
        let mut bids = vec![
            ConsolidateLevel::from_level(Level::from_strs("test1", "99", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test1", "98", "10")),
            ConsolidateLevel::from_level(Level::from_strs("test1", "97", "10")),
        ];
        let bids_update = vec![
            Level::from_strs("test1", "99", "5"),
            Level::from_strs("test1", "98", "15"),
            Level::from_strs("test2", "96", "10"),
        ];
        Consolidate::update_side(&mut bids, bids_update, false);
        let level1 = &bids[0];
    ...
    fn test_update_and_add_into_asks_side() {
        ...
        let asks_update = vec![
            Level::from_strs("test1", "102", "5"),
            Level::from_strs("test1", "104", "15"),
            Level::from_strs("test2", "109", "10"),
        ];
        Consolidate::update_side(&mut asks, asks_update, true);
        let level1 = &asks[0];
    ...
    fn test_book_amounts() {
        let mut book = Consolidate {
            bids: vec![
                ConsolidateLevel::from_level(Level::from_strs("test1", "99", "10")),
                ConsolidateLevel::from_level(Level::from_strs("test2", "97", "10")),
                ConsolidateLevel::from_level(Level::from_strs("test1", "95", "10")),
            ],
            asks: vec![
                ConsolidateLevel::from_level(Level::from_strs("test1", "102", "10")),
                ConsolidateLevel::from_level(Level::from_strs("test1", "104", "10")),
                ConsolidateLevel::from_level(Level::from_strs("test2", "106", "10")),
            ]
        };
        let book_update1 = BookUpdate {
            exchange: "test1",
            bids: vec![
                Level::from_strs("test1", "100", "10"),
                Level::from_strs("test1", "97", "5"),
                Level::from_strs("test1", "95", "5"),
            ],
            asks: vec![
                Level::from_strs("test1", "103", "10"),
                Level::from_strs("test1", "105", "10"),
                Level::from_strs("test1", "106", "5"),
            ],
        };
        ...
        let book_update2 = BookUpdate {
            exchange: "test2",
            bids: vec![
                Level::from_strs("test2", "100", "20"),
                Level::from_strs("test2", "97", "15"),
                Level::from_strs("test2", "94", "10"),
            ],
            asks: vec![
                Level::from_strs("test2", "102", "10"),
